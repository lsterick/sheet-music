...
\score {
  ...
  \new Staff \relative c {
    ...
    \new Voice = "vocals" {
      ...
      % (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ°ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡ÃÂÃÂÃÂÃÂ°ÃÂÃÂ¯ÃÂÃÂ¼ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂµ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ»ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ»)
      \time 3/4
      g,4 \( bes f'
      \time 4/4
